			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form action="{{route('categorys')}}" method="post" class="form-horizontal">
						@csrf
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Category Add</label>
							  <div class="controls">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  @foreach ($categories as $category)
							<tr>
								...
								<td class="center">{{Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $category->created_at)->format('Y-m-d')}}</td>
								<td class="center">
